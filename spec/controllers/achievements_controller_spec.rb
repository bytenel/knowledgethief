  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved achievement as @achievement" do
        ...
        post :create, {:achievement => { "summary" => "invalid value" }}, valid_session
        assigns(:achievement).should be_a_new(Achievement)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested achievement" do
        ...
        Achievement.any_instance.should_receive(:update_attributes).with({ "summary" => "MyString" })
        put :update, {:id => achievement.to_param, :achievement => { "summary" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the achievement as @achievement" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Achievement.any_instance.stub(:save).and_return(false)
        put :update, {:id => achievement.to_param, :achievement => { "summary" => "invalid value" }}, valid_session
        assigns(:achievement).should eq(achievement)
      end
