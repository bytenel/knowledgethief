  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved resume as @resume" do
        ...
        post :create, {:resume => { "user_id" => "invalid value" }}, valid_session
        assigns(:resume).should be_a_new(Resume)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested resume" do
        ...
        Resume.any_instance.should_receive(:update_attributes).with({ "user_id" => "1" })
        put :update, {:id => resume.to_param, :resume => { "user_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the resume as @resume" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Resume.any_instance.stub(:save).and_return(false)
        put :update, {:id => resume.to_param, :resume => { "user_id" => "invalid value" }}, valid_session
        assigns(:resume).should eq(resume)
      end
