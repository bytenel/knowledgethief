  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved education as @education" do
        ...
        post :create, {:education => { "resume_id" => "invalid value" }}, valid_session
        assigns(:education).should be_a_new(Education)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested education" do
        ...
        Education.any_instance.should_receive(:update_attributes).with({ "resume_id" => "1" })
        put :update, {:id => education.to_param, :education => { "resume_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the education as @education" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Education.any_instance.stub(:save).and_return(false)
        put :update, {:id => education.to_param, :education => { "resume_id" => "invalid value" }}, valid_session
        assigns(:education).should eq(education)
      end
