  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved skill as @skill" do
        ...
        post :create, {:skill => { "resume_id" => "invalid value" }}, valid_session
        assigns(:skill).should be_a_new(Skill)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested skill" do
        ...
        Skill.any_instance.should_receive(:update_attributes).with({ "resume_id" => "1" })
        put :update, {:id => skill.to_param, :skill => { "resume_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the skill as @skill" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Skill.any_instance.stub(:save).and_return(false)
        put :update, {:id => skill.to_param, :skill => { "resume_id" => "invalid value" }}, valid_session
        assigns(:skill).should eq(skill)
      end
